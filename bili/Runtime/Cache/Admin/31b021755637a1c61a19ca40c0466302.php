              ...
              <div class="row">
                  <div class="col-lg-12">
                      ...
                      <ol class="breadcrumb">
                          ...
                          <li><i class="fa fa-files-o"></i>栏目添加</li>
                      </ol>
                  </div>
              </div>
              <!-- Form validations -->
                      ...
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <div class="form quick-post">
                                  ...
                                  <form class="form-horizontal" method="post" action="<?php echo U(MODULE_NAME.'/Category/runAddCate');?>">
                                      <!-- Title -->
                                      <div class="form-group">
                                          <label class="control-label col-lg-2" for="title">栏目名称</label>
                                          <div class="col-lg-10">
                                      ...
                                      <!-- Tags -->
                                      <div class="form-group">
                                          <label class="control-label col-lg-2" for="tags">排序</label>
                                          <div class="col-lg-10">
                                              <input type="text" class="form-control" id="tags" name="sort" value="100">
                                          </div>
                                      </div>
