...
<section id="container" class="">
    ...
    <section id="main-content">
        <section class="wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-table"></i>博客管理</h3>
                    <ol class="breadcrumb">
                        <li><i class="fa fa-home"></i><a href="index.html">首页</a></li>
                        <li><i class="fa fa-table"></i>博客管理</li>
                        <li><i class="fa fa-th-list"></i>查看博客</li>
                    </ol>
                </div>
            </div>
            <!-- page start-->
                    ...
                    <section class="panel">
                        ...
                        <table class="table table-striped table-advance table-hover">
                            ...
                            <tr>
                                ...
                                <th><i class="icon_profile"></i> 博客分类 </th>
                                <th><i class="icon_calendar"></i> 博客主标题 </th>
                                <th><i class="icon_mail_alt"></i> 博客副标题 </th>
                                <th><i class="icon_pin_alt"></i> 博客点击量 </th>
                                <th><i class="icon_mobile"></i> 博客时间 </th>
                                <th><i class="icon_pin_alt"></i> 博客内容 </th>
                                <th><i class="icon_cogs"></i> 操作 </th>
                            </tr>
                            <?php if(is_array($blog)): foreach($blog as $key=>$blog_v): ?><tr>
                                    <td><?php echo ($blog_v["id"]); ?></td>
                                    <td><?php echo ($blog_v["blogcate"]); ?></td>
                                    <td><?php echo ($blog_v["blogfirsttitle"]); ?></td>
                                    <td><?php echo ($blog_v["blogsecondtitle"]); ?></td>
                                    <td><?php echo ($blog_v["click"]); ?></td>
                                    <td><?php echo ($blog_v["time"]); ?></td>
                                    <td><?php echo ($blog_v["content"]); ?></td>
                                    <td>
                                        <div class="btn-group">
                                            <a class="btn btn-primary" href="#"><i class="icon_plus_alt2"></i></a>
                                            <a class="btn btn-success" href="#"><i class="icon_check_alt2"></i></a>
                                            <a class="btn btn-danger" href="<?php echo U(MODULE_NAME.'/Blog/delete',array('id'=>$blog_v['id']));?>"><i class="icon_close_alt2"></i></a>
                                        </div>
                                    </td>
