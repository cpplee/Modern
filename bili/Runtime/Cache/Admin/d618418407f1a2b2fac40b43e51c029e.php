   ...
   <aside>
    ...
    <section id="main-content">
        <section class="wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-table"></i>产品管理</h3>
                    <ol class="breadcrumb">
                        <li><i class="fa fa-home"></i><a href="index.html">首页</a></li>
                        <li><i class="fa fa-table"></i>产品管理</li>
                        <li><i class="fa fa-th-list"></i>查看产品</li>
                    </ol>
                </div>
            </div>
            <!-- page start-->
                    ...
                    <section class="panel">
                        ...
                        <table class="table table-striped table-advance table-hover">
                            ...
                            <tr>
                                ...
                                <th><i class="icon_profile"></i> CID </th>
                                <th><i class="icon_calendar"></i> 产品名称 </th>
                                <th><i class="icon_mail_alt"></i> 图片title </th>
                                <th><i class="icon_pin_alt"></i> 图片alt </th>
                                <th><i class="icon_mobile"></i> 图片分组标识符 </th>
                                <th><i class="icon_pin_alt"></i> 图片地址 </th>
                            ...
                            <?php if(is_array($product)): foreach($product as $key=>$v): ?><tr>
                                ...
                                <td><?php echo ($v["pictitle"]); ?></td>
                                <td><?php echo ($v["picalt"]); ?></td>
                                <td><?php echo ($v["pic"]); ?></td>
                                <td>
                                    <div class="btn-group">
                                        <a class="btn btn-primary" href="#"><i class="icon_plus_alt2"></i></a>
                                        <a class="btn btn-success" href="#"><i class="icon_check_alt2"></i></a>
                                        <a class="btn btn-danger" href="<?php echo U(MODULE_NAME.'/Product/deletePic',array('id'=>$v['id']));?>"><i class="icon_close_alt2"></i></a>
                                    </div>
                                </td>
